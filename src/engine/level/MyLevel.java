...
public class MyLevel extends Level{
	...
	public void create(MyDNA dna, int type)
	{
		...
		for (int x = 0; x < width-EXITOFFSET; x++)
		{
        ...
        String chr = dna.getChromosome();
        for (int i = 0; i < chr.length(); i++) {
            char limiter = chr.charAt(i);
            if (limiter == '0') {
                this.setBlock(i + STARTOFFSET, DEFAULTHEIGHT-3, ROCK);
            } else if (limiter == '1' || limiter == '4') {
                this.setBlock(i + STARTOFFSET, DEFAULTHEIGHT-3, COIN);
            } else if (limiter == '3' || limiter == '5') {
                this.setBlock(i + STARTOFFSET, DEFAULTHEIGHT-5, ROCK);
            } else if (limiter == '2' || limiter == '7') {
